...
SCREEN_WIDTH = 1200
SCREEN_HEIGHT = 576
TITLE = "Chowder's Cartoon Adventure"
FPS = 30
...
# Images
idle = load_image('assets/images/characters/chowder.png')
...
hurt = load_image('assets/images/characters/chowder_hurt.png')
...
tile_images = { "Grass": load_image('assets/images/tiles/platformPack_tile001.png'),
                ...
                "Cabinet": load_image('assets/images/tiles/file_cabinet.png'),
                "Sand": load_image('assets/images/tiles/sand.png')}
        
basic_enemy_images = [ load_image('assets/images/characters/kimchi.png'),
                       load_image('assets/images/characters/kimchi_b.png')]

basic_enemy2_images = [ load_image('assets/images/characters/muscle_man.png'),
                       load_image('assets/images/characters/muscle_man_b.png') ]

basic_enemy3_images = [ load_image('assets/images/characters/patty.png'),
                       load_image('assets/images/characters/patty_b.png') ]

platform_enemy_images = [ load_image('assets/images/characters/shnitzel.png'),
                          load_image('assets/images/characters/shnitzel_b.png') ]

platform_enemy2_images = [ load_image('assets/images/characters/rigby.png'),
                          load_image('assets/images/characters/rigby_b.png') ]

platform_enemy3_images = [ load_image('assets/images/characters/spongebob.png'),
                          load_image('assets/images/characters/spongebob_b.png') ] 
...
class BasicEnemy2(pygame.sprite.Sprite):
    '''
    BasicEnemies move back and forth, turning around whenever
    they hit a block or the edge of the world. Gravity affects
    BasicEnemies, so they will walk off platforms.
...
class BasicEnemy3(pygame.sprite.Sprite):
    '''
    BasicEnemies move back and forth, turning around whenever
    they hit a block or the edge of the world. Gravity affects
    BasicEnemies, so they will walk off platforms.
...
class PlatformEnemy2(BasicEnemy):
    '''
    PlatformEnemies behave the same as BasicEnemies, except
    that they are aware of platform edges and will turn around
    when the edge is reached. Only init and the overridden
...
class PlatformEnemy3(BasicEnemy):
    '''
    PlatformEnemies behave the same as BasicEnemies, except
    that they are aware of platform edges and will turn around
    when the edge is reached. Only init and the overridden
...
class Level():
    ...
    def load_enemies(self):
        ...
        for element in self.map_data['enemies']:
            ...
            elif kind == "BasicEnemy2":
                s = BasicEnemy(x, y, basic_enemy2_images)
            elif kind == "BasicEnemy3":
                s = BasicEnemy(x, y, basic_enemy3_images)
            elif kind == "PlatformEnemy":
                s = PlatformEnemy(x, y, platform_enemy_images)
            elif kind == "PlatformEnemy2":
                s = PlatformEnemy(x, y, platform_enemy2_images)
            elif kind == "PlatformEnemy3":
                s = PlatformEnemy(x, y, platform_enemy3_images) 
